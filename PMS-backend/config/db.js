...
db.Notification = require("../models/notfication")(sequelize, Sequelize);
db.Notebook = require("../models/notebook")(sequelize, Sequelize);
...
db.Division.belongsTo(db.sector, { foreignKey: "sector_id", as: "Sectors" });
...
db.Division.hasMany(db.Project, { foreignKey: "division_id", as: "project" });
db.Project.belongsTo(db.Division, {
