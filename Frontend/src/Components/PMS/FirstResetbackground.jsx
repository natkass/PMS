...
import FirstResetcontainer from "./FirstResetcontainer";
import { CheckCircle, TrendingUp, Group, OpenInNew } from "@mui/icons-material";

const FirstResetbackground = () => {
  return (
    <div className="min-h-screen flex items-center justify-center px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -top-20 sm:-top-30 md:-top-40 -right-20 sm:-right-30 md:-right-40 w-40 sm:w-60 md:w-80 h-40 sm:h-60 md:h-80 bg-purple-600 rounded-full mix-blend-multiply filter blur-sm opacity-20 animate-pulse"></div>
        <div className="absolute -bottom-20 sm:-bottom-30 md:-bottom-40 -left-20 sm:-left-30 md:-left-40 w-40 sm:w-60 md:w-80 h-40 sm:h-60 md:h-80 bg-blue-600 rounded-full mix-blend-multiply filter blur-sm opacity-20 animate-pulse animation-delay-2000"></div>
      </div>
...
export default FirstResetbackground;
